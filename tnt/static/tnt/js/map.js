...
function initmap() {
	...
	$.ajax({
		...
		success: function(response) {
			...
			L.marker([51.438130, 5.468477]).addTo(map).bindPopup("Philips IntelliVue X3" + "<br><a href='http://10.66.101.99/product/philips-intellivue-x3/'>Details</a>");
			L.marker([51.437800, 5.468380]).addTo(map).bindPopup("Verathon BladderScan BVI 9400" + "<br><a href='http://10.66.101.99/product/verathon-bladderscan-bvi-9400/'>Details</a>");
		}
	});
}
